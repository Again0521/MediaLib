    ...
    private static func tokens(for preset: AppThemePreset) -> AppThemeTokens {
        ...
        case .graphite, .oled:
            return AppThemeTokens(
                ...
                primary: AppThemeColorToken(lightHex: "3D5AFE", darkHex: "6C8CFF"),
                secondary: AppThemeColorToken(lightHex: "4A5D7A", darkHex: "8EA2C8"),
                accent: AppThemeColorToken(lightHex: "3D5AFE", darkHex: "7EA1FF"),
                background: AppThemeColorToken(lightHex: "F0F2F7", darkHex: "0B0D10"),
        ...
        case .coral:
            return AppThemeTokens(
                ...
                primary: AppThemeColorToken(lightHex: "FF6B5A", darkHex: "FF7A68"),
                secondary: AppThemeColorToken(lightHex: "F2A08F", darkHex: "D99A8D"),
                accent: AppThemeColorToken(lightHex: "F25F4C", darkHex: "FF7A68"),
                background: AppThemeColorToken(lightHex: "FFF5F2", darkHex: "1A1112"),
                ...
                border: AppThemeColorToken(lightHex: "EBD8D2", darkHex: "47302D"),
                textPrimary: AppThemeColorToken(lightHex: "1D1D1F", darkHex: "F5F5F7"),
        ...
        case .lime:
            return AppThemeTokens(
                ...
                primary: AppThemeColorToken(lightHex: "7CB342", darkHex: "A7D85A"),
                secondary: AppThemeColorToken(lightHex: "9BBE68", darkHex: "AFCB7A"),
                accent: AppThemeColorToken(lightHex: "6FAE36", darkHex: "A7D85A"),
                background: AppThemeColorToken(lightHex: "F5FAEF", darkHex: "10170F"),
        ...
        case .orange, .warm, .apricot:
            return AppThemeTokens(
                ...
                primary: AppThemeColorToken(lightHex: "E08A3E", darkHex: "F0A45A"),
                secondary: AppThemeColorToken(lightHex: "C59B6A", darkHex: "D7B385"),
                accent: AppThemeColorToken(lightHex: "D97928", darkHex: "F0A45A"),
                background: AppThemeColorToken(lightHex: "FBF4EA", darkHex: "19120D"),
        ...
        case .classic, .ocean, .indigo, .purple, .rose, .mint, .green, .frosted, .custom:
            return AppThemeTokens(
                ...
                primary: AppThemeColorToken(lightHex: "007AFF", darkHex: "64AFFF"),
                secondary: AppThemeColorToken(lightHex: "5AC8FA", darkHex: "64D2FF"),
                accent: AppThemeColorToken(lightHex: "0A84FF", darkHex: "409CFF"),
                background: AppThemeColorToken(lightHex: "F5F7FB", darkHex: "111821"),
